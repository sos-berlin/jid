...
public class SchedulerOrderHistoryDBItemPostgres extends SchedulerHistoryLogDBItemPostgres {
    ...
    public SchedulerOrderHistoryDBItemPostgres() {
    ...
    public boolean equals(final Object h) {
        return ((SchedulerOrderHistoryDBItemPostgres) h).getJobChain().equals(this.getJobChain())
                && ((SchedulerOrderHistoryDBItemPostgres) h).getOrderId().equals(this.getOrderId());
    }
