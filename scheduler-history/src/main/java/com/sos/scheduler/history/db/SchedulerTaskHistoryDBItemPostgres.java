...
public class SchedulerTaskHistoryDBItemPostgres extends SchedulerHistoryLogDBItemPostgres {
    ...
    public SchedulerTaskHistoryDBItemPostgres() {
    ...
    public boolean equals(Object h) {
        return ((SchedulerTaskHistoryDBItemPostgres) h).getJobName().equals(this.getJobName());
    }
