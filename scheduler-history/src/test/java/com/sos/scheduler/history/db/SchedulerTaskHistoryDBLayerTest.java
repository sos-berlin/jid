...
public class SchedulerTaskHistoryDBLayerTest {
	...
	public void testDeleteString() throws ParseException {
		...
		schedulerTaskHistoryDBLayer.getFilter().setExecutedTo("2011-10-01 00:00:00");
	...
	public void testGetSchedulerTaskHistoryList() throws ParseException {
		...
		List<SchedulerTaskHistoryDBItem>  historyList = schedulerTaskHistoryDBLayer.getSchedulerHistoryListFromTo(); 
		assertEquals("testGetSchedulerTaskHistoryList fails...:",1,historyList.size());
	}
	...
	public void testGetTaskHistoryItems() throws Exception {
		schedulerTaskHistoryDBLayer.getFilter().setExecutedFrom("2011-01-01 00:00:00");
		schedulerTaskHistoryDBLayer.getFilter().setExecutedTo(new Date());
  		List<SchedulerTaskHistoryDBItem>  historyList = schedulerTaskHistoryDBLayer.getHistoryItems(); 
	...
	public void testGetTaskHistoryItem() throws Exception {
		...
		assertEquals("testGetTaskHistoryItem fails...:",id,schedulerHistoryDBItem.getId());
	}
	...
	public void testSaveHistory() {
		...
		schedulerTaskHistoryDBLayer.beginTransaction(); 
		SchedulerTaskHistoryDBItem loadedhistory=schedulerTaskHistoryDBLayer.get(id); 
