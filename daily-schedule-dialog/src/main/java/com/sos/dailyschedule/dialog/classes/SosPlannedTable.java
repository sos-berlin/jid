...
public class SosPlannedTable extends SOSTable implements ISOSTable {
    ...
    public void createTable() {
        ...
        // new SOSTableColumn(this, DashBoardConstants.conSOSDashB_JOBCHAIN /*
        // "Job Chain" */, 100, Messages);
        // new SOSTableColumn(this, DashBoardConstants.conSOSDashB_ORDER /*
        // "Order" */, 100, Messages);
        new SOSTableColumn(this, DashBoardConstants.conSOSDashB_Planned /* "Planned" */, 100, messages, SOSTableColumn.ColumnType.DATE);
        new SOSTableColumn(this, DashBoardConstants.conSOSDashB_Executed /*
                                                                          * "Executed"
                                                                          * ,
                                                                          */, 100, messages, SOSTableColumn.ColumnType.DATE);
        new SOSTableColumn(this, DashBoardConstants.conSOSDashB_END /* "Ended", */, 100, messages, SOSTableColumn.ColumnType.DATE);
        new SOSTableColumn(this, DashBoardConstants.conSOSDashB_DURATION /*
                                                                          * "Duration"
                                                                          * ,
                                                                          */, 90, messages, SOSTableColumn.ColumnType.DATE);
