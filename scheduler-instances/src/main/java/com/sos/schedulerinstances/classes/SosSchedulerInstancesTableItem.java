...
public class SosSchedulerInstancesTableItem extends SOSTableItem implements ISOSTableItem {
    ...
    public void setColor() {
        ...
        if (schedulerInstancesDBItem != null && schedulerInstancesDBItem.getIsPaused()) {  // Keine
                                                                                          // Ausführung
            this.setBackground(0, gray);  // Ausführung in der Zukunft
            this.setBackground(STATUS_COLUMN_NUMBER, gray);  // Ausführung in der
                                                            // Zukunft
        } else {
    ...
    public void setColumns() {
        ...
        textBuffer = new String[] { d.getSchedulerId(), d.getHostname(), d.getTcpPortValue(),
                ...
                d.getDbName(), d.getDbHistoryTableName(), d.getDbOrderHistoryTableName(), d.getDbOrdersTableName(), d.getDbTasksTableName(),
                d.getDbVariablesTableName(), d.getWorkingDirectory(), d.getLiveDirectory(), d.getLogDir(), d.getIncludePath(), d.getIniPath(), "",
                // "",
                // "",
                // "",
                // "",
                d.getParam(), d.getSupervisorHostName(), d.getSupervisorTcpPortValue(), d.getJettyHttpPortValue(), d.getJettyHttpsPortValue(), "" };
