...
public class SosDailyScheduleTableItem extends SOSTableItem implements ISOSTableItem {
    ...
    public void setColor() {
        ...
        if (dailyScheduleDBItem.getScheduleExecuted() == null) {  // Keine
                                                                 // Ausführung
            if (dailyScheduleDBItem.getExecutionState().isLate()) { // Hätte
                                                                    // ausgeführt
                                                                    // werden
                                                                    // müssen
                ...
                this.setBackground(STATUS_COLUMN_NUMBER, gray);  // Ausführung in
                                                                // der Zukunft
            }
        } else {
            ...
            if (dailyScheduleDBItem.haveError()) { // Fehlerhafte Ausführung
                ...
                if (dailyScheduleDBItem.getExecutionState().isLate()) { // Verspätete
                                                                        // Ausführung
